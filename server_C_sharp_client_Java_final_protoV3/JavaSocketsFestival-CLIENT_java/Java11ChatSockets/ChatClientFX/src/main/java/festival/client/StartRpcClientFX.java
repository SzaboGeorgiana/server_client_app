...
import festival.client.gui.AngajatView;
import festival.network.rpcprotocol.ChatServicesRpcProxy;
...
//                getClass().getClassLoader().getResource("angajat-view.fxml"));
//        Parent croot=cloader.load();
//
//
//        AngajatView chatCtrl =
//                cloader.<AngajatView>getController();

...
public class AngajatView  implements Initializable,IChatObserver{
...
//        f1();
    ...
    public void f2() {
        ...
        if(calendar.getValue()!=null) {
            try {
                LocalDateTime selectedDate = calendar.getValue().atStartOfDay();
    ...
    public void f3() {
        try {
            ...
            if (index > -1) {
                ...
                System.out.println("biletul cu locurile: "+sp.getNr_locuri());
...
// Construirea textului combinând data ca șir și indexul
    ...
    private void loggoutButton() throws IOException {
        try {
            this.service.logout(angajat, (IChatObserver) this);
